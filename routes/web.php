...
route::get('/profile_sekolah',function(){
	return view('/home/layout/frontend/profile');
});
route::get('/kompetisi_keahlian',function(){
	return view('/home/layout/frontend/komke');
});
route::get('/galeri_sekolah',function(){
	return view('/home/layout/frontend/galeri');
});
